...
class secondwindow(QWidget):
    ...
    def initUI(self):
        ...
        btn1 = QPushButton('1시간', self)
        btn1.move(80, 40)
        btn1.resize(240,60)
        btn1.clicked.connect(self.btn_clicked1)

        btn2 = QPushButton('2시간', self)
        btn2.move(80, 115)
        btn2.resize(240,60)
        btn2.clicked.connect(self.btn_clicked2)

        btn3 = QPushButton('3시간', self)
        btn3.move(80, 185)
        btn3.resize(240,60)
        btn3.clicked.connect(self.btn_clicked3)

        btn4 = QPushButton('4시간', self)
        btn4.move(80, 255)
        btn4.resize(240,60)
        btn4.clicked.connect(self.btn_clicked4)

        btn5 = QPushButton('5시간', self)
        btn5.move(80, 325)
        btn5.resize(240,60)
        btn5.clicked.connect(self.btn_clicked5)

        btn6 = QPushButton('6시간', self)
        btn6.move(80, 395)
        btn6.resize(240,60)
        btn6.clicked.connect(self.btn_clicked6)
